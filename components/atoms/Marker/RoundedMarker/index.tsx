...
<div class="mapgl-marker-animation" style="box-sizing: border-box; background-size : cover; filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25)); transition:0.5s; width:80px; height:80px;">
  ...
  <div style="position:absolute;top:1px; left: 1px; clip-path: path('M55 58H38.7862C38.0843 58 37.4047 58.246 36.8656 58.6953L33.35 61.625L29 65.25L21.6339 58.7505C21.0858 58.2669 20.38 58 19.649 58H3C1.34315 58 0 56.6569 0 55V3C0 1.34315 1.34315 0 3 0H55C56.6569 0 58 1.34315 58 3V55C58 56.6569 56.6569 58 55 58Z'); ">
    <div style=" width:80px; height:80px; background : url(${src}); background-size : cover; background-position:center; transform:translate(-10px,-10px)" ></div>
  </div>
